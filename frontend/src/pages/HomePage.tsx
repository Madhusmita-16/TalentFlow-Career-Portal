...
import { Search, ArrowRight, TrendingUp, Users, Target, BookOpen, ShieldCheck } from 'lucide-react';
      ...
      <div>
        ...
        <section className="relative bg-slate-900 text-white overflow-hidden py-16 lg:py-24 border-b border-slate-800">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
              ...
              >
                ...
                <div className="bg-white p-2 rounded-xl shadow-panel border border-slate-200 flex flex-col sm:flex-row items-center gap-2 max-w-2xl mb-8 text-slate-900">
                  ...
                  <Link
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-sky-600 hover:bg-sky-700 text-white font-semibold text-sm rounded-lg transition flex items-center justify-center gap-2 shadow-sm shrink-0"
                  >
            ...
            {/* Interactive Demo Video Component showing ALL 7 Navigation Views */}
            <div className="pt-4">
              <DemoVideoShowcase />
            </div>
          </div>
